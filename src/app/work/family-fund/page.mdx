...
export const caseStudy = {
  client: 'EasyMoney University',
  title: 'Discover Your Path to Financial Freedom',
  description:
    ' It is the biggest online tranding community in Algeria with over 24000 active students. Led by seasoned traders, they train their students towards halal trading.',
  summary: [
    'FamilyFund is the biggest online trading university in Algeria with over 24000 daily active students',
    'We built their system th',
